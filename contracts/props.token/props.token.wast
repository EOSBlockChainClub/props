(module
 ...
 (data (i32.const 1568) "comparison of assets with different symbols is not allowed\00")
 (data (i32.const 1632) "The amount you are trying to transfer is more than the auto pay limit set by you.\00")
 (data (i32.const 1728) "transfer the hashtag ammount\00")
